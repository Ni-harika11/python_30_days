# # # # # # # # # Boolean
# # # # # # # # # A boolean data type represents the truth / false value only.
# # # # # # # # # Operators: Several kind of operators are avaible in pythons.
# # # # # # # # 1)Assignment Operators(symbol: =)
# # # # # # # # 2)Arithmetic operators(symbols: +, -, *, /, %, **, //)
...
# # # # # It is used to comapre two values. It returns a boolean value either True or False.
...
# # # Logical Operators
# # # It combine the conditions and give  the result either True or False. The logical operators are and, or, not.
